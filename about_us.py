...
# PAGE CONFIG
# -----------------------------------------------------------
st.set_page_config(page_title="SMART_BRICKS", layout="wide")
...
# HEADER
# -----------------------------------------------------------
st.markdown("<h1 class='title'>🏠 SMART_BRICKS</h1>", unsafe_allow_html=True)
st.markdown("<p class='subtitle'>Building Smarter, Sustainable Homes with Data Intelligence</p>", unsafe_allow_html=True)

st.write("""
Smart_Bricks is an AI-powered real estate evaluation platform that empowers users with transparent, 
...
- ☁️ **Cloud Deployment:** Deploy Smart_Bricks on scalable cloud platforms (AWS / GCP) for seamless performance and availability.  
...
st.write("📧 smartbricks@gmail.com")
st.write("🌍 www.smartbricks.ai")
...
st.markdown("""
<div class="footer">
    <b>SMART_BRICKS</b> © 2025 — Innovating Real Estate Intelligence with AI
</div>
""", unsafe_allow_html=True)
